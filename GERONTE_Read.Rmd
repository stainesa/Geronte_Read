...
#DIRECTORY = "APN"
#DIRECTORY = "EOS"
#DIRECTORY = "FPROG" # BLANK DIRECTORY
#DIRECTORY = "HOSPITA"
#DIRECTORY = "INC"
#DIRECTORY = "INSTI"
#DIRECTORY = "SAE"
DIRECTORY = "TRT" # SAS FORMAT file is empty
#DIRECTORY = "VIS_3M"
#DIRECTORY = "VIS_6M"
#DIRECTORY = "VIS_9M"
#DIRECTORY = "VIS_12M"
...
```{r Read SAS_Category}
RR <- readLines(paste0(DIRECTORY, "/GERONTE_FRONE20230407_SAS_Category.txt"),
...
```{r Read SAS_FORMAT}
RR <- readLines(paste0(DIRECTORY, "/GERONTE_FRONE20230407_SAS_Format.txt"),
                       encoding = 'UTF-8', skipNul = TRUE)
RR <- str_replace_all(RR, "\xff\xfe", "")
str(RR)
```
...
```{r Read SAS_LABEL}
RR <- readLines(paste0(DIRECTORY, "/GERONTE_FRONE20230407_SAS_Label.txt"),
                       encoding = 'UTF-8', skipNul = TRUE)
RR <- str_replace_all(RR, "\xff\xfe", "")
str(RR)
```
...
```{r Read SAS_QLU}
RR <- readLines(paste0(DIRECTORY, "/GERONTE_FRONE20230407_SAS_QLU.txt"),
                encoding = 'UTF-8', skipNul = TRUE)
RR <- str_replace_all(RR, "\xff\xfe", "")
str(RR)
```
...
```{r Read SAS_Type}
RR <- readLines(paste0(DIRECTORY, "/GERONTE_FRONE20230407_SAS_Type.txt"),
                encoding = 'UTF-8', skipNul = TRUE)
RR <- str_replace_all(RR, "\xff\xfe", "")
str(RR)
```
...
```{r Read SAS_DATA}
RR <- readLines(paste0(DIRECTORY, "/GERONTE_FRONE20230407_SAS_Data.txt"),
                encoding = 'UTF-8', skipNul = TRUE)
RR <- str_replace_all(RR, "\xff\xfe", "")
str(RR)
```
